...
type AppThemeColors = {
  ...
  muted: string; subtle: string; primaryBg: string; primaryText: string; successBg: string; successText: string;
  warnBg: string; warnText: string; danger: string; surface: string;
};
